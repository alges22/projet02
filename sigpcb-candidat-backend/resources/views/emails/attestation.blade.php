...
<html>
    <head>
        ...
        <title>Demande d'attestation de permis</title>
        <style>
    ...
    <body>
        <h1>Attestation de Permis</h1>
        <div class="message">
            <p>Cher utilisateur,</p>
            <p>Votre attestation de permis est : <strong>disponible</strong></p>
            <center>
                <a href="{{ $envoie }}" style="display: inline-block; padding: 12px 24px; background-color: #52a8b9; color: #ffffff; text-decoration: none;">Télécharger</a>
            </center>
