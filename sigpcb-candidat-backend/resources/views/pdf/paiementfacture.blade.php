...
<body>
    ...
    <div class="header">
        <div class="top">
            <div class="logo">
                <img src="{{ asset('logo.png') }}" alt="Logo de l'ANaTT">
            </div>
        ...
        <div class="bottom">
            <div class="date">Cotonou, le {{ \Carbon\Carbon::now()->locale('fr_FR')->isoFormat('Do MMMM YYYY') }}
            </div>
        </div>
    </div>
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>{{ $dossierSession['montant'] }}</td>
                </tr>
                <tr>
                    <td class="title">Numéro de paiement</td>
                    <td>{{ $dossierSession['phone_payment'] }}</td>
                </tr>
                <tr>
                    <td class="title">Date de paiement</td>
                    <td>{{ \Carbon\Carbon::parse($dossierSession['date_payment'])->isoFormat('dddd DD MMMM YYYY', 'Do MMMM YYYY') }}
                    </td>
                </tr>
            </table>
        </div>
