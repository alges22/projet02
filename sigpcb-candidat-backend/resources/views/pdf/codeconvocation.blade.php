...
<div class="header">
    ...
    <div class="bottom">
        <div class="references">
            ...
            <p>{{strtoupper($dossierSession['annexe']['name'])}}</p>
    ...
    <div>EXAMEN DE PERMIS DE CONDUIRE - {{ strtoupper($dossierSession['examen']['session_long']) }}</div>
</div>
...
<div class="content">
    ...
    <div>
        ...
        <div style="margin-top: 1rem;">
            <span>Nous avons le plaisir de vous informer que vous êtes convoqué (e) à la composition de l’épreuve du code de
            l’examen du permis de conduire qui se tiendra aux lieu et date ci-dessous mentionnés :</span>
            ...
            <ul>
                <li>
                    <strong>Lieu :</strong>
                    <span>
                        Agence Nationale des Transports Terrestres, {{ strtoupper($dossierSession['annexe']['name']) }}, {{$dossierSession['salle']['name']}}, Vague {{$dossierSession['vague']['numero']}}
                    </span>
                </li>

                <li>
                    <strong>Date :</strong>
                    <span>{{ \Carbon\Carbon::parse($dossierSession['examen']['date_code'])->isoFormat('dddd DD MMMM YYYY', 'Do MMMM YYYY') }}, Heure : 8H 00</span>
                </li>
            </ul>
        </div>
