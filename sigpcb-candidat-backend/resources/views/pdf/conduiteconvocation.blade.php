...
<div class="content">
    ...
    <div>
        ...
        <div style="margin-top: 1rem;">
            <span>Suite à votre réussite à l’épreuve du code de l'examen du permis de conduire session du {{ \Carbon\Carbon::parse($dossierSession['examen']['date_code'])->isoFormat('dddd DD MMMM YYYY', 'Do MMMM YYYY') }}, vous êtes expressément invité à vous présenter a l'ANaTT - {{$dossierSession['annexe']['name']}} pour la composition de l’épreuve de la conduite, <span style="color:#005e5e">le {{ \Carbon\Carbon::parse($dossierSession['conduiteVague']['date_compo'])->isoFormat('dddd DD MMMM YYYY', 'Do MMMM YYYY') }} à 7h30mn, muni obligatoirement de votre pièce d'identité (carte nationale biométrique ou CIP).</span> </span>
        </div>
    </div>
    ...
    <div>
        ...
        <table width="100%" border="1">
            ...
            <tr>
                <td class="titles">Jury</td>
                <td>{{$dossierSession['conduiteJury']['name']}}</td>
            </tr>
            <tr>
            ...
            <tr>
                    <td>
                        <div style="font-size: 22px">
                            Scannez ce code QR pour marquer la présence du candidat.
                        </div>
                    </td>
                    <td>
                        <img src="data:image/png;base64,{{ base64_encode($qrCode) }}" alt="QR Code">
