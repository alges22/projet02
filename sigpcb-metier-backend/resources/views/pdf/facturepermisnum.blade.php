    ...
    <div>
        ...
        <table>
            <tr>
                ...
                <td>{{$fullDossier['npi']}}</td>
            </tr>
            <tr>
                <td class="title">Nom</td>
                <td>{{$fullDossier['nom']}}</td>
            </tr>
            <tr>
                <td class="title">Prénoms</td>
                <td>{{$fullDossier['prenoms']}}</td>
            </tr>
            <tr>
                <td class="title">Catégorie de permis</td>
                <td>{{$fullDossier['categorie_permis']}}</td>
            </tr>
            <tr>
                <td class="title">Montant payé</td>
                <td>{{$fullDossier['montant']}}</td>
            </tr>
            <tr>
                <td class="title">Numéro de paiement</td>
                <td>{{$fullDossier['phone_payment']}}</td>
            </tr>
            <tr>
                <td class="title">Date de paiement</td>
                <td>{{ \Carbon\Carbon::parse($fullDossier['date_payment'])->isoFormat('dddd DD MMMM YYYY', 'Do MMMM YYYY') }}</td>
            </tr>
        </table>
    </div>
