...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "question_ids" => "question (s)",
        "reponse_id" => "réponse",
        "vague_id" => "vague",
        "user_id" => "utilisateur",
        "signataire_id" => "signataire",
        "acte_signable_id" => "acte signable",
        "text" => "texte",
        "time" => "temps",
        "langue_id" => "langue",
        "categorie_permis_id" => "catégorie permis",
        "fichier_signature" => "fichier de signature",
        "profil_ids" => "profil (s)"
    ],
