...
class Handler extends ExceptionHandler
{
    ...
    public function handleException(Request $request, Throwable $exception)
    {
        ...
        if ($exception instanceof UserHasNotAccessException) {
            return Resp::error($exception->getMessage(), statuscode: 403, responsecode:403);
        }
    ...
    private function sendNotifications(Throwable $e)
    {
        ...
        if (!$isLocal) {
            ...
            $messager->subject("Une erreur s'est produite sur ANaTT (ADMIN)");
