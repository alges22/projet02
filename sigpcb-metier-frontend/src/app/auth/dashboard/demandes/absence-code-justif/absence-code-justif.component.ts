...
@Component({
  selector: 'app-absence-code-justif',
  templateUrl: './absence-code-justif.component.html',
  styleUrls: ['./absence-code-justif.component.scss'],
})
export class AbsenceCodeJustifComponent {
  justification = '';
  ...
  save(event: Event) {
    ...
    formData.append('examen_type', 'code-conduite');
