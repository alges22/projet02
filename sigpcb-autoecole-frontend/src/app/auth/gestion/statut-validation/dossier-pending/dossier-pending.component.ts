...
@Component({
  selector: 'app-dossier-pending',
  templateUrl: './dossier-pending.component.html',
  styleUrls: ['./dossier-pending.component.scss'],
})
export class DossierPendingComponent implements OnInit {
