...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('candidat_conduite_detail_rpses', function (Blueprint $table) {
            $table->id();
            $table->foreignId('bareme_conduite_id')->constrained();
            $table->foreignId('conduite_vague_id')->constrained();
            $table->foreignId('sub_bareme_id')->constrained();
    ...
    {
        Schema::dropIfExists('candidat_conduite_detail_rpses');
    }
};
