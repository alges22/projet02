...
export class AuthService {
  ...
  checklocalnpi(param: any): Observable<any> {
    return this.http.post<any>(apiUrl(this.URLS.checklocalnpi), param);
  }

  checknpi(param: any): Observable<any> {
    return this.http.post<any>(apiUrl(this.URLS.checknpi), param);
  }
  ...
  opt(param: any) {
    ...
    return this.http.post<any>(apiUrl('/verify-otp'), param);
  }
   ...
   */
  resendOpt(param: any) {
    return this.http.post<any>(apiUrl('/resend-code'), param);
  }
  /**
   *  Mot de passe oublié
   * @param email
