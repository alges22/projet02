...
@Component({
  selector: 'app-rejet-auth-permis',
  templateUrl: './rejet-auth-permis.component.html',
  styleUrls: ['./rejet-auth-permis.component.scss'],
})
export class RejetAuthPermisComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
