...
@Component({
  selector: 'app-validate-remplacement-permis',
  templateUrl: './validate-remplacement-permis.component.html',
  styleUrls: ['./validate-remplacement-permis.component.scss'],
})
export class ValidateRemplacementPermisComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
