import { DuplicataRemplacementService } from './../../../../core/services/duplicata-remplacement.service';
...
@Component({
  selector: 'app-init-remplacement-permis',
  templateUrl: './init-remplacement-permis.component.html',
  styleUrls: ['./init-remplacement-permis.component.scss'],
})
export class InitRemplacementPermisComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
