...
@Component({
  selector: 'app-validate-echange-permis',
  templateUrl: './validate-echange-permis.component.html',
  styleUrls: ['./validate-echange-permis.component.scss'],
})
export class ValidateEchangePermisComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
