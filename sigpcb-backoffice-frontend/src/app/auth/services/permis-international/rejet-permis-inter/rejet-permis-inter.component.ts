...
@Component({
  selector: 'app-rejet-permis-inter',
  templateUrl: './rejet-permis-inter.component.html',
  styleUrls: ['./rejet-permis-inter.component.scss'],
})
export class RejetPermisInterComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
