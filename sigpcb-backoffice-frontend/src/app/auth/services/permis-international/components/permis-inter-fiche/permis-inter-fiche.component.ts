...
@Component({
  selector: 'app-permis-inter-fiche',
  templateUrl: './permis-inter-fiche.component.html',
  styleUrls: ['./permis-inter-fiche.component.scss'],
})
export class PermisInterFicheComponent {
  candidat: any;
  @Output('validate') validateEvent = new EventEmitter<{
    data: PermisInternational;
    state: State;
  }>();
  @Input('data') data: PermisInternational | null = null;
  previewUrl = '';
