...
@Component({
  selector: 'app-validate-examinateur',
  templateUrl: './validate-examinateur.component.html',
  styleUrls: ['./validate-examinateur.component.scss'],
})
export class ValidateExaminateurComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
