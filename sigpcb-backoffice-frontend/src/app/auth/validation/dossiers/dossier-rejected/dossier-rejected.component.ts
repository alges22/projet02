...
@Component({
  selector: 'app-dossier-rejected',
  templateUrl: './dossier-rejected.component.html',
  styleUrls: ['./dossier-rejected.component.scss'],
})
export class DossierRejectedComponent {
