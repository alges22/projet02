...
@Component({
  selector: 'app-agreement-valides',
  templateUrl: './agreement-valides.component.html',
  styleUrls: ['./agreement-valides.component.scss'],
})
export class AgreementValidesComponent {
  pageNumber = 1;
  paginate_data: any = {};
  ready = true;
  agrements: any[] = [];
